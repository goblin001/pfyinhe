...
Install() {
	if [[ ${release} == "centos" ]]; then
		...
		wget https://gitee.com/yinheecc/brook/releases/download/v20210401/brook_linux_amd64 -O /usr/bin/brook && chmod +x /usr/bin/brook
		echo -e " ${Tip} 正在安装Gost..."
		...
		wget https://gitee.com/yinheecc/tinyPortMapper/releases/download/20200818.0/tinymapper_binaries.tar.gz && tar -xzf tinymapper_binaries.tar.gz && mv -f /root/tinymapper_amd64 /usr/bin/tinymapper && rm -f tinymapper* && chmod +x /usr/bin/tinymapper
